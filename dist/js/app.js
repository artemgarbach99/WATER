(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-reason__slider")) new core(".main-reason__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        if (document.querySelector(".main-catalog__slider")) new core(".main-catalog__slider", {
            modules: [],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
